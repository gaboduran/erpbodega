...
try {
    ...
    $spreadsheet->getActiveSheet()
      ...
      foreach ($resultado as $row) {
            ...
            $resultado['NOMCATEGORIA']    = $row['NOMCATEGORIA'];
            ...
            ->setCellValue('C' . $fila, strtoupper($resultado['NOMCATEGORIA']))
            ->setCellValue('D' . $fila, strtoupper($resultado['NOMCLIENTE']))
            ->setCellValue('E' . $fila, strtoupper($resultado['ESTADO']));
      $fila++;
      }

      header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
      header('Content-Disposition: attachment;filename="MaestroCategoria.xlsx"');
