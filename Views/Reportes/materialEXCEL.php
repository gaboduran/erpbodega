...
try {
    ...
    $spreadsheet->getActiveSheet()
      ...
      foreach ($resultado as $row) {
            ...
            $resultado['NOMMATERIAL']       = $row['NOMMATERIAL'];
            ...
            ->setCellValue('C' . $fila, strtoupper($resultado['NOMMATERIAL']))
            ->setCellValue('D' . $fila, strtoupper($resultado['DESCRIPCION']))
            ->setCellValue('E' . $fila, strtoupper($resultado['ESTADO']));
      $fila++;
      }
      header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
      header('Content-Disposition: attachment;filename="Maestromaterial.xlsx"');
