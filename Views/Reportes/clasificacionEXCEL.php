...
$db = new Conexion();
$stringSQL = "SELECT clasificacion.ID, CODIGO, DESCRIPCION, cliente.NOMCLIENTE, CASE WHEN clasificacion.ESTADO = 1 THEN 'activo' ELSE 'inactivo' END AS ESTADO
FROM clasificacion
...
try {
    ...
    $spreadsheet->getActiveSheet()
      ...
      header('Content-Disposition: attachment;filename="MaestroClasificacion.xlsx"');
