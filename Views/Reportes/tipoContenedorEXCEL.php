...
try {
    ...
    $spreadsheet->getActiveSheet()
      ...
      foreach ($resultado as $row) {
            ...
            $resultado['GRUPOCONT']         = $row['GRUPOCONT'];
            $resultado['ISOCODE']           = $row['ISOCODE'];
            ...
            ->setCellValue('D' . $fila, strtoupper($resultado['GRUPOCONT']))
            ->setCellValue('E' . $fila, strtoupper($resultado['ISOCODE']))
            ->setCellValue('F' . $fila, strtoupper($resultado['ESTADO']));
      $fila++;
      }
      header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
      header('Content-Disposition: attachment;filename="MaestroTipoContenedor.xlsx"');
