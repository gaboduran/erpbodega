...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(20,10,'LISTADO GENERAL REPARACIONES',0,0,'C');
...
try {
    ...
    $pdf->Cell(30,5,'CODREPARA',0,0,'L',1);
    $pdf->Cell(60,5,'NOMBRESP',0,0,'L',1);
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        foreach ($listado as $row => $column) {
            ...
            $pdf->setX(9);
            $pdf->Cell(30,5,$column["CODREPARA"],0,0,'C',1);
    ...
    $pdf->Output('I','MaestroReparacionesContenedor');
