...
try {
    ...
    $spreadsheet->getActiveSheet()
          ...
          ->setCellValue('D1', "TIPOMOVIMIENTO")
      ...
      foreach ($resultado as $row) {
            ...
            $resultado['NOMTIPOMOV']        = $row['NOMTIPOMOV'];
            ...
            ->setCellValue('D' . $fila, strtoupper($resultado['NOMTIPOMOV']))
            ->setCellValue('E' . $fila, strtoupper($resultado['ESTADO']));
      $fila++;
      }
      header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
      header('Content-Disposition: attachment;filename="MaestroMovimientos.xlsx"');
