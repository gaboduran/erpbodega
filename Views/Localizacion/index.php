                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="p-2"> <?php if (permisos::create()) { ?>
                                <button class="btn btn-success btn-sm nuevoLocalizaModal"><i class="fa fa-plus-circle"></i> Nuevo</button>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="tblLocalizacion" class="table table-bordered table-striped compact nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Componente</th>
...
<div class="modal fade" id="localizaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <?php include('../teus/views/Localizacion/localizaModal.php'); ?>
</div>
