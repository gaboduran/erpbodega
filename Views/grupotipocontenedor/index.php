                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="mr-auto p-2">
                            <div class="btn-group dropright">
                                ...
                                <div class="dropdown-menu">
                                    <form id="frmRptGeneralPorteria" name="frmRptGeneralPorteria" method="POST" action="">
                        ...
                        <div class="p-2"> <?php if (permisos::create()) { ?>
                                <button class="btn btn-success btn-sm grupoTipoModal"><i class="fa fa-plus-circle"></i> Nuevo</button>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="tblGrupotipo" class="table table-bordered table-striped nowrap display compact" style="width:100%">
...
<div class="modal fade" id="GrupoTipoContModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <?php include('../teus/views/grupotipocontenedor/GrupoTipoContModal.php'); ?>
</div>
