<form id="frmgrupotipocont" name="frmgrupotipocont" action="" method="POST">
  <div class="modal-dialog" style="max-width:380px!important;">
    <div class="modal-content">
      ...
      <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="txt_codigo" id="txt_codigo" class="form-control form-control-sm" maxlength="30" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" style="text-transform:uppercase;">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
         <div class="col-md-6">
          <input type="hidden" name="idgrupoticont" id="idgrupoticont"/>
