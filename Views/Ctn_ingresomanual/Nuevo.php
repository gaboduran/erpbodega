            ...
            <div class="card">
                ...
                <?php //debug(ctn_ingresomanualModel::getOneIngreso(24)) ?>
                    <form id="frmIngresoCont" name="frmIngresoCont" method="POST">
						<input type="hidden" id="idingreso" name="idingreso" class="form-control form-control-sm" id="exampleInputEmail1" value="">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <button type="button" class="btn btn-success Uploadfotos" id="btn_Uploadfotos" onclick="Uploadfotos();" disabled><i class="fa fa-camera"></i> FOTOS</button>
                        <button type="button" class="btn btn-warning" id="btn_inspeccion" onclick="IngresoDanos();" disabled><i class="fa fa-wrench"></i> INSPECCION</button>
                    </div>
            </div>
        </div>
    </div>
