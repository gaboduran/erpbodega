        ...
        <form id="frmMedidasArea" name="frmMedidasArea" method="POST">
            <div class="modal-body">
                <div class="form-group row">
                    <label for="txt_componente" class="col-sm-2 col-form-label">Largo</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control form-control-sm" id="largo_modal" name="largo_modal" required maxlength="5" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                    </div>
                </div>
                <div class="form-group row">
