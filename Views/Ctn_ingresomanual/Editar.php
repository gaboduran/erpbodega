    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                ...
                if(isset($ingresodata[0]->ID)){
                ?>
                  
                
                    <form id="frmIngresoCont" name="frmIngresoCont" method="POST">
						<input type="hidden" id="idingreso" name="idingreso" class="form-control form-control-sm" id="exampleInputEmail1" value="<?php echo (isset($ingresodata[0]->ID) ? ucwords($ingresodata[0]->ID) : ''); ?>">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <button type="button" class="btn btn-success" id="btn_Uploadfotos" onclick="Uploadfotos();"><i class="fa fa-camera"></i> FOTOS</button>
                        <button type="button" class="btn btn-warning" id="btn_inspeccion" onclick="IngresoDanos();"><i class="fa fa-wrench"></i> INSPECCION</button>
                    </div>
                    <?php }else{
                        echo 'La variable no esta defida';
