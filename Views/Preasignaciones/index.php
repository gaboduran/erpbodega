          ...
          <div class="col-md-12 col-sm-12 ">
              <div class="card card-info card-outline">
                  <div class="card-header">
                      <h3 class="card-title">
                          <h6><i class="fa fa-gavel"></i> <?Php echo $data['page_name']; ?></h6>
                      </h3>
                  </div>
                  <div class="card-body">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-3 col-sm-3">
                                  <div class="form-group">
                                      ...
                                      <input class="form-control" type="text" name="txt_bookinkindx" id="txt_bookinkindx" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="100">
                      ...
                      <?php if (permisos::create()) { ?>
                          <div align="right">
                              <button class="btn btn-success btn-sm preasignacionesModal"><i class="fa fa-plus-circle"></i> Nuevo</button>
                          </div>
                      <?php } ?>
                      <div id="test" style="float: right;"></div>
                      <div class="table-responsive">
                          <table id="tblPreasignaciones" class="display" style="width:100%">
                              <thead>
                                  <tr>
                                      <th>ID</th>
                                      <th>Nro. Reserva</th>
  ...
  <div class="modal fade" id="preasignacionesModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <?php include('../teus/views/Preasignaciones/preasignacionesModal.php'); ?>
  </div>
  <div class="modal fade" id="contenedoresPreasignadosModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <?php include('../teus/views/Preasignaciones/contenedoresPreasignadosModal.php'); ?>
  </div>
