                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="p-2"> <?php if (permisos::create()) { ?>
                                <button class="btn btn-success btn-sm empresasModal"><i class="fa fa-plus-circle"></i> Nuevo</button>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="tblEmpresas" class="table table-bordered table-striped compact nowrap" style="width:100%">
                            <thead>
                                <tr>
                                <th>Id</th>
                                <th>Codigo</th>
...
<div class="modal fade" id="empresasModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <?php include('../teus/views/transportes/empresasModal.php');?>
</div>
