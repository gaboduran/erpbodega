<form id="frmClasificacion" name="frmClasificacion" action="" method="POST">
          ...
          <div class="col-md-6 col-sm-6">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="txt_codclasificacion" id="txt_codclasificacion" class="form-control form-control-sm" maxlength="10" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" style="text-transform:uppercase">
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="txt_desclasificacion" id="txt_desclasificacion" class="form-control form-control-sm" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
              </div>
            </div>
          </div>
        </div>
