<div class="modal-dialog" style="max-width:680px!important;">
    <div class="modal-content">
        ...
        <form id="frmdetalledano" name="frmdetalledano" method="POST" enctype="multipart/form-data">
            <input type="hidden" class="form-control form-control-sm" id="txt_idingreso" name="txt_idingreso" value = "0">
            <input type="text" class="form-control form-control-sm" id="txt_idlinea" name="txt_idlinea">
            <div class="modal-body">
                ...
                <input type="text" name="txt_idplantilla" id="txt_idplantilla" class="form-control form-control-sm" maxlength="100">
                <input type="text" name="txt_iditem" id="txt_iditem" class="form-control form-control-sm" maxlength="100">
                <input type="text" name="operation" id="operation" class="form-control form-control-sm" maxlength="100">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="btn_procesaDano" onclick="procesar();" ;><i class="fa fa-floppy-o"></i> Agregar</button>
