<form id="frmCargo" name="frmCargo" action="" method="POST">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="txt_codigo" id="txt_codigo" class="form-control form-control-sm" maxlength="2" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" style="text-transform:uppercase;">
              </div>
            </div>
          </div>
        </div>
