                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="p-2"> <?php if (permisos::create()) { ?>
                                <button class="btn btn-success btn-sm planeacionModal"><i class="fa fa-plus-circle"></i> Nuevo</button>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="table-responsive">

                        <table id="tblPlaneacion" class="table table-bordered table-striped nowrap display compact" style="width:100%">
...
<div class="modal fade" id="planeacionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <?php include('../teus/views/planeacion/planeacionModal.php'); ?>
</div>
