          ...
          <div class="col-md-12 col-sm-12">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" name="txt_nomperfil" id="txt_nomperfil" class="form-control form-control-sm" maxlength="30" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
              </div>
            </div>
          </div>
        </div>
