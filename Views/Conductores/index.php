                    ...
                    <div class="d-flex">
                        <div class="mr-auto p-2">
                            <div class="btn-group dropright">
                                <button class="btn btn-success btn-sm duplicaModal"><i class="fa fa-files-o"></i> Duplicar</button>
                        ...
                        <div class="p-2"> <?php if (permisos::create()) { ?>
                                <button class="btn btn-success btn-sm isocodeModal"><i class="fa fa-plus-circle"></i> Nuevo</button>
                            <?php } ?>
                        </div>
                    </div>
...
<div class="modal fade" id="isocodeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <?php include('../teus/views/isocodes/isocodeModal.php'); ?>
</div>
<div class="modal fade" id="duplicaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <?php include('../teus/views/categoria/duplicaModal.php'); ?>
</div>
