...
<div class="modal fade" id="TarifaTallerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<?php include('../teus/views/contrato/TarifaTallerModal.php');?>
</div>
